...
public abstract class Mask {
    ...
    public static TextWatcher insert(final String mask, final EditText ediTxt, final int index, final int InputTypeBefore, final int InputTypeAfter) {
        return new TextWatcher() {
            boolean isUpdating;
            String old = "";
    ...
    public static TextWatcher insert(final String mask, final EditText ediTxt, final Runnable runnable, final Activity activity) {
        return new TextWatcher() {
            boolean isUpdating;
            String old = "";
