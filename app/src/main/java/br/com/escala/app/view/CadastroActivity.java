...
import br.com.escala.app.model.RegisterErrors;
            ...
            disposable.add(RestClient.getInstance().createUser(usuario)
                    ...
                    .doOnError(throwable -> {
                        ...
                        if (throwable instanceof HttpException) {
                            ...
                            Log.i("TAG", "Falha no cadastro: " + registerErrors.getErrors().getError());
                            // mostrar a mensagem do servidor pro usuario

                            Toast.makeText(CadastroActivity.this, registerErrors.getErrors().getError(), Toast.LENGTH_LONG).show();
//                            Toast.makeText(CadastroActivity.this, registerErrors.getErrors().getError(), Toast.LENGTH_LONG).show();
                        }
